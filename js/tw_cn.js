...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function translateBody(fobj) {
    ...
    for (let i = 0; i < objs.length; i++) {
      ...
      if (
        ...
        obj === translateButtonObject || obj === translateRightmenu
      ) { continue }
  ...
  function translatePage() {
    if (targetEncoding === 1) {
      currentEncoding = 1
      targetEncoding = 2
      translateRightmenu.innerHTML = translateButtonObject.innerHTML = msgToTraditionalChinese
      ...
      currentEncoding = 2
      targetEncoding = 1
      translateRightmenu.innerHTML = translateButtonObject.innerHTML = msgToSimplifiedChinese
      saveToLocal.set(targetEncodingCookie, targetEncoding, 2)
      translateBody()
  ...
  function translateInitialization() {
    translateRightmenu = document.getElementById("translateRightmenu")
    translateButtonObject = document.getElementById('translateLink')
    if (translateButtonObject) {
      if (currentEncoding !== targetEncoding) {
        setTimeout(translateBody, translateDelay)
        if (targetEncoding === 1) translateRightmenu.innerHTML = translateButtonObject.innerHTML = msgToSimplifiedChinese
        else translateRightmenu.innerHTML = translateButtonObject.innerHTML = msgToTraditionalChinese
      }
