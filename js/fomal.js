...
function tonav() {
  ...
  document.getElementById("page-name").innerText = document.title.split(" | Doremious")[0];
}
...
var img = new Image();
var img2 = new Image();
img.src = "/assets/myosotis.png"
img2.src = "/assets/myosotis2.png"
...
Sakura.prototype.draw = function (cxt) {
  ...
  if (this.color)
    ...
    cxt.drawImage(img2, 0, 0, 20 * this.s, 20 * this.s)
  //樱花大小
  cxt.restore();
}
...
function switchNightMode() {
  ...
  let color = document.documentElement.getAttribute('data-theme') === 'light' ? 'rgb(154,154,251)' : 'rgb(142,193,253)'
...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| Doremious") ? title.substring(0, title.length - 12) : title;
    navigator.clipboard.writeText('标题：' + subTitle + '\n链接：' + url + '\nWelcome to Doremious\' daily time!');
    new Vue({
      data: function () {
        this.$notify({
          title: "🎈成功复制分享信息",
